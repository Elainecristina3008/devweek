...
public class FaixaEtariaController {
    ...
    private FaixaEtariaRepo faixaEtariaR;

    public FaixaEtariaController(FaixaEtariaRepo faixaEtariaR) {
        this.faixaEtariaR = faixaEtariaR;
    }

    public FaixaEtariaController(){
    ...
    public ResponseEntity<?> findAllFaixaEtaria(){
        try{
            List<FaixaEtaria> lista = faixaEtariaR.findAll();
